...
export interface Pallet {
  ...
  max_length?: number; // Calculated: length + (2 * max_overhang) - kept for backward compatibility
  max_width?: number; // Calculated: width + (2 * max_overhang) - kept for backward compatibility
  max_height: number;
  max_weight?: number;
